  ...
  return (
	...
	<div className="md:h-16 h-28 mx-auto md:px-4 container flex items-center justify-between flex-wrap md:flex-nowrap">
		...
		<div className=" flex text-indigo-500">
			<div><img src="https://flowbite.com/docs/images/logo.svg" className="h-6 mr-3 sm:h-9" alt="Flowbite Logo"/></div>
      <div><span className="self-center text-xl font-semibold whitespace-nowrap text-indigo-500">Dharmsinh Desai University</span></div>
		</div>
		<div className="text-gray-500 order-3 w-full md:w-auto md:order-2 ">
			<ul className="flex font-semibold justify-between">
                {/* <!-- Active Link = text-indigo-500
                Inactive Link = hover:text-indigo-500 --> */}
			<Link to='/Homepage'><li className="md:px-4 md:py-2 text-indigo-500 hover:bg-blue-600 hover:text-white">
                <div className='flex'>
